    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        private fun setupListeners() {
            ...
            proxySharing.setOnPreferenceClickListener {
                if (proxySharing.isChecked) requireActivity().toast(R.string.toast_warning_pref_proxysharing)
                restartProxy()
                true
            }
        ...
        private fun updatePerAppProxy(modeStr: String?) {
            perAppProxy.isEnabled = (modeStr == "VPN")
            if (modeStr != "VPN") perAppProxy.isChecked = false
        }
